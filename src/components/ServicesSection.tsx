...
export const ServicesSection: React.FC = () => {
  ...
  return (
    <section id="services" className="py-20 bg-gradient-to-b from-blue-100/50 via-indigo-50/30 to-purple-100/40 dark:from-slate-950/80 dark:via-indigo-950/30 dark:to-slate-950/80 relative border-t border-blue-200/50 dark:border-indigo-900/50">
                ...
                <div>
                  ...
                  {service.image && (
                    <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-900 border-b border-slate-100 dark:border-slate-700/60">
                      ...
                      <div className="absolute top-3 left-3 w-10 h-10 rounded-xl bg-white/95 dark:bg-slate-900/95 flex items-center justify-center text-blue-600 dark:text-blue-400 shadow-md">
